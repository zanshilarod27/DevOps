...
<center><form method="post" action="/saveDetails"  align = "center">   
   <font face = "Georgia" size = "5" color = "grey"> How much would you like to borrow?  &nbsp </font><input type="number" name="lamount" required><font face = "Georgia" size = "5" color = "grey">&nbsp &pound</font><br><br>
   <font face = "Georgia" size = "5" color = "grey"> Annual Interest Rate &nbsp</font><input type="number" name="annrate" step=".01" required><font face = "Georgia" size = "5" color = "grey"> &nbsp %</font><br><br>
   <font face = "Georgia" size = "5" color = "grey">How long would you like to borrow it for? &nbsp</font><input type="number" name="lperiod" required><font face = "Georgia" size = "5" color = "grey"> &nbsp months</font><br><br>
